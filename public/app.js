      ...
      if (data.success) {
        ...
        if (machineContainer && machineContainer.style.display === 'block' && typeof lottie !== 'undefined' && lottieAnimations.slots) {
          ...
          if (lottieAnimations.slots.reel1.symbols[symbol1]) {
            ...
            symbol1Container.innerHTML = `<div style="font-size: 70px; line-height: 70px; text-align: center;">${symbol1}</div>`;
          }
          ...
          if (lottieAnimations.slots.reel2.symbols[symbol2]) {
            ...
            symbol2Container.innerHTML = `<div style="font-size: 70px; line-height: 70px; text-align: center;">${symbol2}</div>`;
          }
          ...
          if (lottieAnimations.slots.reel3.symbols[symbol3]) {
            ...
            symbol3Container.innerHTML = `<div style="font-size: 70px; line-height: 70px; text-align: center;">${symbol3}</div>`;
          }
...
const lottieAnimations = {
  ...
  bowling: {
    ...
    results: [
      ...
      '/animations/bowling_2.json', // результат 2 - 2 кегли
      '/animations/bowling_3.json', // результат 3 - 3 кегли
      '/animations/bowling_4.json', // результат 4 - 4 кегли
      '/animations/bowling_5.json', // результат 5 - 5 кеглей
      '/animations/bowling_6.json'  // результат 6 - страйк (все кегли)
    ]
  },
  football: {
  ...
  basketball: {
    default: '/animations/basketball_3.json', // Для показа перед броском
    results: [
      null, // индекс 0 не используется
      '/animations/basketball_3.json', // результат 1 - не попал
      '/animations/basketball_3.json', // результат 2 - не попал
      '/animations/basketball_3.json', // результат 3 - не попал
      '/animations/basketball_5.json', // результат 4 - попал
      '/animations/basketball_5.json'  // результат 5 - попал
    ]
  },
  darts: {
